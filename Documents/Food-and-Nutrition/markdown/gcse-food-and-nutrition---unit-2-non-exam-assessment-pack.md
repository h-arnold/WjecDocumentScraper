...
This pack contains the assessment materials for Unit 2: Food Investigation.
...
Group work is allowed. Candidates can collaborate for task/s 1 and 2.
...
This candidate assessment pack is for candidates completing Unit 2: Food Investigation.
...
## Assessment grids for non-examination assessment

## Banded mark schemes

Banded mark schemes are divided so that each band within a section has a relevant descriptor. The descriptor for the band provides a description of the performance level for that band. Each band contains marks. Before marking, the teacher should first read and annotate a candidate's project to pick out the evidence that is being assessed. Once the annotation is complete, the mark scheme can be applied.
...
Follow the stages of the food investigation plan to prove or disprove your hypothesis.

## (a) Collecting result

The candidate has used methods of data collection specified in their food investigation plan, complete the following tasks:

- conduct a food investigation to test the hypothesis
- modify the chosen variables to test the hypothesis
- used methods of sensory quality testing to conduct a sensory quality analysis test.

## (b) Presenting results

The candidate has used methods to present their results such as:
...
The candidate has reflected on the hypothesis they (or the group) developed during Task 1. This reflection has been based on:

- an analysis of the data and results collected during the food investigation
- a comparison of actual results collected compared to expected outcomes.

## (b) Evaluation

The candidate has evaluated the food investigation based on the following considerations:
