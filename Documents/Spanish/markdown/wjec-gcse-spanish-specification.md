...
The GCSE Spanish qualification must support learners to:
...
We have also considered where the qualification can generate opportunities for integrating the learning experiences noted on p.18 ; the Guidance for Teaching will include further information on integrating these learning experiences into delivery.

The GCSE Spanish qualification supports the Curriculum for Wales by:

- supporting the statements of what matters[1](#page-5-3) , giving learners the opportunity to:
...
- supporting the key considerations for language development[3](#page-6-1) by giving learners the opportunity to:
...
The GCSE Spanish qualification will also be based on the following:
...
- an everyday <sup>4</sup> [la](#page-6-2)nguage list
- a core vocabulary list based on high frequency and high utility vocabulary[5](#page-6-3)
...
<span id="page-6-0"></span><sup>2</sup> [Languages, Literacy and Communication: Principles of progression -](https://hwb.gov.wales/curriculum-for-wales/languages-literacy-and-communication/principles-of-progression/) Hwb (gov.wales)

<span id="page-6-1"></span><sup>3</sup> [Languages, Literacy and Communication: Designing your curriculum -](https://hwb.gov.wales/curriculum-for-wales/languages-literacy-and-communication/designing-your-curriculum/) Hwb (gov.wales)

<span id="page-6-2"></span><sup>4</sup> The role and purpose of the everyday language list is to provide teachers and learners with a useful reference of what to cover pre-GCSE.
...
The qualification provides a suitable foundation for the study of Spanish at either AS or A level. In addition, the specification provides a coherent, satisfying and worthwhile course of study for learners who do not progress to further study in this subject.

## <span id="page-7-1"></span>1.4 Guided learning hours

GCSE Spanish has been designed to be delivered within 120 – 140 guided learning hours. The qualification has been primarily designed as a 2-year programme for learners in years 10 and 11.

## <span id="page-7-2"></span>1.5 Use of language
...
- learn and use the grammar list and Spanish sound-spelling correspondences in Appendix A
...
- translate short and simple texts from Spanish to Cymraeg/English.
...
In this unit, learners will gain the knowledge and skills required to understand and respond to spoken Spanish.
...
In this unit, learners will gain the knowledge, skills and understanding required to respond to written Spanish.

Learners will study a work in Spanish in one of the following genres: graphic novel, short story, film script, novel.

Centres will have the freedom to choose their own works and different learners may choose to study different works. Regardless of the work chosen, the purpose of this unit is for learners to engage with a Spanish work and write about it in Spanish. It is likely that some works will contain words that are outside of the vocabulary lists; in this case teachers will need to ensure that learners understand the general message, learners are not expected to understand every word, the purpose is to be able to write about the work they have studied.

WJEC will provide example works for each genre in Spanish.

For written production in Spanish, the expected language will be from the specified content (the grammar and sound-spelling correspondence in **Appendix A,** and the vocabulary in **Appendix B**).
...
In this unit learners will gain the knowledge and skills required to understand spoken Spanish.
...
In this unit, learners will gain the knowledge and skills required to understand and respond to written Spanish.
...
GCSE Spanish generates opportunities for the following learning experiences to be developed (experiences will not be directly assessed):
...
Before the course starts, the teacher is responsible for informing candidates of WJEC's regulations concerning malpractice. Candidates must not take part in any unfair practice in the preparation of work for GCSE Spanish.
...
## <span id="page-23-0"></span>5.1 Making entries
...
## <span id="page-23-1"></span>5.2 Grading, awarding and reporting
...
## <span id="page-24-1"></span>Spanish grammar and sound-spelling correspondences

GCSE learners will be expected to demonstrate their knowledge and understanding of the grammar and structures of Spanish. Assessment materials will only use the aspects of grammar outlined in Appendix A; unless indicated in the right-hand column as receptive grammar only, learners will be required to demonstrate both receptive and productive knowledge of the grammar from the list.
...
Learners will be expected to know the Spanish alphabet and will need to know the soundspelling correspondences listed below. The list specifies key differences in sound-spelling correspondences between Spanish and Cymraeg/English which learners will need to learn at GCSE to be able to read out loud with sufficient accuracy at this level. It is not an exhaustive list of all the sound-spelling correspondences in the Spanish language.
...
## <span id="page-30-1"></span>Everyday Language
...
| estupendo            | wonderful, awesome          |
| estúpido             | stupid                      |
| excelente            | excellent                   |
| fácil                | easy                        |
| fantástico           | fantastic                   |
| fascinante           | fascinating                 |
| fatal                | awful / terrible            |
| fenomenal            | great                       |
| feo                  | ugly                        |
| genial               | great                       |
| gracioso             | funny                       |
...
| inútil               | useless                     |
| llevarse bien/mal    | get on well / bad           |
| odiar                | to hate                     |
| pasarlo bien/mal     | to have a good / bad time   |
| preferido            | favourite / preferred       |
...
| allá           | over there                 |
| alrededor (de) | around                     |
| derecha, a la  | on the right, to the right |
| distancia, la  | distance                   |
...
| caliente                      | hot                           |
| fresco                        | fresh                         |
| haber (nieve, niebla etc.)    | to have snow, fog etc.        |
| hacer (frío, calor, sol etc.) | to be (cold, hot, sunny etc.) |
| hielo, el                     | ice                           |
| lluvia, la                    | rain                          |
| niebla, la                    | fog                           |
| nieve, la                     | snow                          |
| nube, la                      | cloud                         |
| nublado / nubloso             | cloudy                        |
| sol, el                       | sun                           |
...
Learners are expected to know the names of all Spanish-speaking countries and the corresponding nationalities.

| Spanish country/continent | Nationality      | English equivalent                |
|---------------------------|------------------|-----------------------------------|
| continente, el            | -                | continent                         |
...
| Spanish     | English equivalent        |
|-------------|---------------------------|
| barrio, el  | neighbourhood, district   |
| bosque, el  | forest                    |
| calle, la   | street                    |
| campo, el   | countryside, pitch, field |
| capital, la | capital                   |
| centro, el  | the centre, middle        |
| ciudad, la  | city, town                |
| costa, la   | coast                     |
| isla, la    | island                    |
| lago, el    | lake                      |
...
| montaña, la | mountain                  |
| playa, la   | beach                     |
| plaza, la   | square, marketplace       |
| pueblo, el  | village, small town       |
| región, la  | region                    |
| río, el     | river                     |
| zona, la    | area, zone                |
...
|-----------------------------|--------------------|
| contar                      | to count           |
| cuarto, (el), cuarta (la)   | fourth / quarter   |
| número, el                  | number             |
| primero, (el), primera (la) | first, the first   |
| mil                         | thousand           |
| millón                      | million            |
| novecientos                 | nine hundred       |
| quinto, (el), quinta (la)   | fifth, the fifth   |
| quinientos                  | five hundred       |
| segundo, (el), segunda (la) | second, the second |
| setecientos                 | seven hundred      |
| tercero, (el), tercera (la) | third, the third   |
...
| gorra, la                | cap                       |
|--------------------------|---------------------------|
| jersey, el               | jumper, sweater, pullover |
| medias, las              | tights                    |
| pantalón, el             | trousers                  |
| pantalón corto, el       | shorts                    |
| reloj, el                | watch, clock              |
| ropa, la                 | clothes                   |
| sombrero, el             | hat                       |
| suéter con capucha, el   | hoodie                    |
| suéter, el               | sweater, jumpers          |
| traje, el                | suit, dress, costume      |
| traje de baño, el        | swimming costume          |
| uniforme, el             | uniform                   |
| vaqueros, los            | jeans                     |
| vestido, el              | dress                     |
| vestir                   | to dress                  |
| zapatilla de deporte, la | trainer (shoe)            |
| zapato, el               | shoe                      |
...
| Dibujo, el                  | art, drawing       |
| Educación Física, la        | PE                 |
| enseñar                     | to teach           |
| Español, el                 | Spanish            |
| estudiar                    | to study           |
| Estudios Audiovisuales, los | media studies      |
| Estudios Empresariales, los | business           |
| Física, la                  | physics            |
| Francés, el                 | French             |
| Galés, el                   | Welsh              |
...
The core vocabulary list is set out by part of speech (adjectives, adverbs, nouns, prepositions, phrases, verbs) the Spanish word and its English equivalent.
...
| además                | furthermore, also, besides     |
...
| fondo, en el/al       | at the back, bottom            |
...
|-------|------------------|-------------------------------|
| n (m) | proyecto         | project, plan                 |
| n (f) | prueba           | proof, evidence, test         |
| n (f) | psicología       | psychology                    |
| n (f) | publicidad       | advertising                   |
| n (m) | público          | public, audience              |
| n (m) | puente           | bridge                        |
| n (m) | puerto           | port, harbour                 |
| n (m) | puesto           | place, position               |
| n (f) | pulsera          | bracelet                      |
| n (m) | punto            | point, full stop, dot         |
| n (f) | quemadura        | burn                          |
| n (f) | quemadura de sol | sunburn                       |
| n (f) | rabia            | anger                         |
| n (f) | ración           | portion                       |
| n (m) | radio            | radio                         |
| n (m) | rato             | while, short time             |
| n (m) | ratón            | mouse                         |
| n (f) | razón            | reason                        |
| n (f) | reacción         | reaction                      |
| n (f) | realidad         | reality                       |
| n (m) | reciclaje        | recycling                     |
| n (m) | recreo           | breaktime                     |
| n (m) | recuerdo         | memory, souvenir              |
| n (m) | recurso          | resource                      |
| n (f) | red              | network (transport, internet) |
| n (m) | regalo           | gift, present                 |
| n (m) | regimen          | diet (to lose weight)         |
| n (f) | regla            | rule                          |
...
| n (f)     | respuesta                | answer              |
| n (m)     | resto                    | rest, remainder     |
| n (m)     | resultado                | result, outcome     |
| n (m)     | resumen                  | summary             |
| n (m)     | reto                     | challenge           |
| n (f)     | reunión                  | meeting             |
| n (f)     | revista                  | magazine            |
| n (m)     | riesgo                   | risk                |
| n (f)     | riqueza                  | riches, wealth      |
| n (f)     | risa                     | laugh, chuckle      |
| n (m)     | ritmo                    | rhythm              |
| n (f)     | rodilla                  | knee                |
| n (m)     | ruido                    | noise               |
| n (f)     | rutina                   | routine             |
| n (m)     | sabor (a)                | taste (of), flavour |
| n (m/f/n) | sacerdote                | vicar, priest       |
| n (m)     | salón                    | living room         |
| n (f)     | salud                    | health              |
| n (f)     | sangre                   | blood               |
| n (m/f/n) | secretario               | secretary           |
| n (m)     | secreto                  | secret              |
| n (f)     | sed                      | thirst              |
| n (f)     | seguridad                | security, safety    |
| n (f)     | señal                    | sign, mark, token   |
| n (f)     | sensación                | feeling, sensation  |
| n (m)     | sentido                  | sense               |
...
|---------|------------------|---------------------------|
| n (f)   | sexualidad       | sexuality                 |
| n (f)   | siesta           | afternoon nap             |
| n (m)   | siglo            | century                   |
| n (m)   | silencio         | silence                   |
| n (m)   | símbolo          | symbol (literature, film) |
| n (f)   | sinagoga         | synagogue                 |
| n (m)   | sistema          | system                    |
| n (m)   | sitio; sitio web | place, site (website)     |
| n (f)   | situación        | situation                 |
| n (f)   | sociedad         | society                   |
| n (m/f) | socio/a          | member                    |
| n (f)   | sociología       | sociology                 |
| n (m/f) | soldado          | soldier                   |
| n (f)   | solución         | solution, answer          |
| n (f)   | sombra           | shadow, shade             |
| n (f)   | sonrisa          | smile                     |
| n (f)   | sorpresa         | surprise                  |
| n (f)   | sostenibilidad   | sustainability            |
| n (f)   | subida           | upload                    |
| n (m)   | sueldo           | salary, wages             |
| n (m)   | suelo            | ground, floor             |
| n (m)   | sueño            | dream, sleep              |
| n (f)   | suerte           | luck, fortune             |
| n (m)   | supermercado     | supermarket               |
| n (m)   | tabaco           | tobacco                   |
| n (f)   | talla            | size (clothing)           |
| n (m)   | tamaño           | size                      |
| n (m)   | tambor           | drum                      |
...
| n (m)     | tatuaje                   | tattoo                       |
|-----------|---------------------------|------------------------------|
| n (m)     | teatro                    | theatre, drama               |
| n (m)     | techo                     | roof                         |
| n (f)     | tecnología                | technology                   |
| n (f)     | tela                      | fabric, material             |
| n (m)     | teléfono                  | phone, telephone             |
| n (f)     | telenovela                | soap opera                   |
| n (m)     | tema                      | issue, subject, matter       |
| n (f)     | temperatura               | temperature                  |
| n (m)     | texto                     | text                         |
| n (f)     | tía                       | aunty                        |
| n (f)     | tienda                    | shop, tent                   |
| n (f)     | tierra / Tierra (planeta) | land, ground/Earth           |
| n (m)     | tío                       | uncle                        |
| n (m)     | tipo                      | type, kind (slang for "guy") |
| n (m)     | título                    | degree, title                |
| n (m/f/n) | trabajador/a              | worker                       |
| n (m)     | trabajo                   | work, job, effort            |
| n (f)     | tradición                 | tradition                    |
| n (f)     | traducción                | translation                  |
| n (m)     | tráfico                   | traffic                      |
| n (m)     | tratamiento               | treatment                    |
| n (m)     | triángulo                 | triangle                     |
| n (f)     | tristeza                  | sadness                      |
| n (m)     | trozo                     | piece                        |
| n (m)     | trueno                    | thunder                      |
| n (m)     | turismo                   | tourism                      |
| n (m/f)   | turista                   | tourist                      |
| n (f)     | universidad               | university                   |
...
|-----------|---------------|----------------------|
| n (f)     | vacuna        | vaccine, vaccination |
| n (m)     | valle         | valley               |
| n (m)     | valor         | value, worth         |
| n (f)     | variedad      | variety              |
| n (m)     | vaso          | (drinking) glass     |
| n (m/f/n) | vecino        | neighbour            |
| n (f)     | venta         | sale                 |
| n (f)     | ventaja       | advantage            |
| n (f)     | verdad        | true, fact           |
| n (f)     | vergüenza     | embarrassment        |
| n (m/f/n) | veterinario/a | veterinarian         |
| n (f)     | víctima       | victim, casualty     |
| n (f)     | vida          | life                 |
| n (f)     | violencia     | violence             |
| n (f)     | visita        | visit, visitor       |
| n (f)     | vista         | view                 |
| n (m)     | volumen       | volume               |
| n (f)     | voluntad      | willingness          |
| n (m/f/n) | voluntario    | volunteer            |
| n (f)     | voz           | voice                |
| n (m)     | vuelo         | flight               |
